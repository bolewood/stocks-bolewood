...
export const WRAPPERS = [
  {
    ...
    sharesNote: "Class A+B+C. GOOG price × all classes ≈ Alphabet market cap (10-Q 2026-06-30).",
  ...
  },
  {
    ...
    sharesNote:
      "Issuer-equivalent ADR shares (2× Tokyo common). OTC ADR prints ~½ the USD-converted 9984.T price (e.g. ¥5,524 / 157.56 JPYUSD ≈ $35 vs SFTBY ~$17 on 2026-08-05), so 2× common × ADR quote ≈ full-issuer cap.",
    anthropic: null,
  ...
  },
  {
    ...
    sharesNote:
      "FILED: NPORT-P 2026-04-30 ($862.4M / $50.38 NAV). ESTIMATED: 21,613,728 as of 2026-07-31 (ARK published SO). Interval fund in continuous offering — share count drifts with subscriptions/repurchases.",
